...
export const LIBRARY_HELP: readonly HelpSection[] = [
  ...
  },
  {
    ...
    points: [
      ...
      'It then learns your pace. Every self-paced step already times itself while you run, so after three sets of something the estimate uses your own time for it rather than the average. Tapping quickly through a routine to see what is in it is ignored, so a dry run does not teach it that a set takes two seconds.',
