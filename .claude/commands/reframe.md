...
every role, template SaaS structure, filler microcopy. Produce a findings table of
component, tell matched, severity and specific replacement direction, and end with the
